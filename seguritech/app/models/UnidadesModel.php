...
class UnidadesModel extends Eloquent{
	...
	protected $table = 'MP_Unidades';
        ...
        protected $fillable = array('IdUnidad','IdTipoUnidad', 'Latitud', 'Longitud', 'Altitud','UltLectura','ButtonPanic','Inhabilitar','AperturaSeguro','AlarmaActiva','LucesEncendidas','SirenaActiva','Evento','Velocidad','EngineOn');
}