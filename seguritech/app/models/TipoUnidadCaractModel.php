...
class TipoUnidadCaractModel extends Eloquent{
	 ...
	 * @var string
	 */
	protected $table = 'MP_TipoUnidadCaract';
        ...
        protected $fillable = array('IdTipoUnidad','IdCaracteristica', 'Caracteristica', 'Obligatorio', 'Ayuda');
}